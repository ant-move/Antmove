...
useReducer({
    WxsImportExpression(node) {
        let { content, dist } = node.body;
                            ...
                            CallExpression (path) {
                                if (
                                    ...
                                    // TODO: Support chained member expressions like require('foo').bar.baz.lol
                                        ...
                                        if (
                                            t.isVariableDeclarator(
                                                memberExpressionPath.parentPath
                                                    .node
                                            ) &&
                                            t.isIdentifier(
                                                memberExpressionPath.parentPath
                            ...
                            MemberExpression (path) {
                                if (
                                    ...
                                    if (
                                        ...
                                        const subMemberExpression =
                                            path.parentPath;
                                        const namedExport =
                                            subMemberExpression.node.property;

                                        if (
                                            t.isAssignmentExpression(
                                                subMemberExpression.parentPath
                                                    .node
                                            ) &&
                                            t.isExpressionStatement(
                                                subMemberExpression.parentPath
