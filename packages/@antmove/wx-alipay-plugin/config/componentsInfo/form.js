...
module.exports = {
  'checkbox-group': {
    ...
    props: {
      ...
      name: createSupportProp('表单提交时的key'),
    },
  },
  checkbox: {
    type: 5,
    ...
    props: {
      ...
      color: createSupportProp('checkbox的颜色'),
    },
  ...
  input: {
    ...
    path: `${customComponentPrefix}/__component/custom-input/custom-input`,
    name: '输入框',
    url: {
  ...
  picker: {
    ...
    props: {
      ...
      range: createSupportProp('mode 为 selector 或 multiSelector 时，range 有效'),
      'range-key': createSupportProp('当 range 是一个 Object Array 时，通过 range-key 来指定 Object 中 key 的值作为选择器显示内容'),
      bindchange: {
        type: 1,
        status: 0,
        desc: '发生改变时触发',
  ...
  'picker-view-column': {
    name: '滚动选择器子项',
    url: {
      wechat: 'https://developers.weixin.qq.com/miniprogram/dev/component/picker-view-column.html',
      alipay: 'https://opendocs.alipay.com/mini/component/picker-view#picker-view-column%20%E6%BB%9A%E5%8A%A8%E9%80%89%E6%8B%A9%E5%99%A8%E5%AD%90%E9%A1%B9',
    },
    desc: '仅可放置于picker-view中，其孩子节点的高度会自动设置成与picker-view的选中框的高度一致',
  },
  radio: {
    name: '单选项目',
    url: {
  ...
  label: {
    name: '用于改进表单组件的可用性',
    url: {
      wechat: 'https://developers.weixin.qq.com/miniprogram/dev/component/label.html',
      alipay: 'https://opendocs.alipay.com/mini/component/label',
    },
    type: 5,
    tagName: 'custom-label',
    path: `${customComponentPrefix}/__component/custom-label/custom-label`,
    status: 0,
    desc: '用于改进表单组件的可用性',
    props: {
      for: {
