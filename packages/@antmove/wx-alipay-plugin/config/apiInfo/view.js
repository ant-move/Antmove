...
module.exports = {
  ...
  getSelectedTextRange: createDescObj(
    2,
    '在input、textarea等focus之后，获取输入框的光标位置',
    'https://developers.weixin.qq.com/miniprogram/dev/api/ui/keyboard/wx.getSelectedTextRange.html',
    '',
  ),
}
