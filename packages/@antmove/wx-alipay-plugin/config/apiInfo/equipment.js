...
module.exports = {
  ...
  onBLEPeripheralConnectionStateChanged: createDescObj(
    2,
    '监听当前外围设备被连接或断开连接事件',
  ...
  offBLEPeripheralConnectionStateChanged: createDescObj(
    2,
  ...
  createBLEPeripheralServer: createDescObj(
    2,
  ...
  offBluetoothAdapterStateChange: createDescObj(
    ...
    'https://opendocs.alipay.com/mini/api/ocgwfe',
  ),
  ...
  getClipboardData: createDescObj(
    2,
    '获取系统剪贴板的内容',
  ...
  offNetworkStatusChange: createDescObj(
    ...
    'https://opendocs.alipay.com/mini/api/gxpg1w',
  ),
  offUserCaptureScreen: createDescObj(
    ...
    'https://opendocs.alipay.com/mini/api/umdxbg',
  ),
  offDeviceMotionChange: createDescObj(
    2,
  ...
  offMemoryWarning: createDescObj(
    0,
    '取消监听内存不足告警事件',
    'https://developers.weixin.qq.com/miniprogram/dev/api/device/performance/wx.offMemoryWarning.html',
    'https://opendocs.alipay.com/mini/api/hszexr',
  ),
}
