...
my.setStorageSync({
    key: "activeComponent",
    data: {
        is: "page/API/pages/background-audio/background-audio"
    }
});
const app = getApp();
...
_Page({
    ...
    _enableInterval() {
        ...
        function update() {
            _my.getBackgroundAudioPlayerState({
                success(res) {
                    that.setData({
