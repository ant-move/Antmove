...
my.setStorageSync({
    key: "activeComponent",
    data: {
        is: "page/cloud/pages/server-date/server-date"
    }
});

const util = require("../../../../util/util.js"); // 参考文档：https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-client-api/database/db.serverDate.html
        ...
        db.collection(collection)
            ...
            .then(res => {
                this.setData({
                    ...
                    // 服务端时间
                    clientDateFormatted: util.formatDateTime(
                        this.data.clientDate,
                        true
                    ),
                    serverDateFormatted: util.formatDateTime(
                        res.data.time,
                        true
                    )
                });
