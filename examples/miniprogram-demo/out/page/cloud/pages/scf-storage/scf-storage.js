...
my.setStorageSync({
    key: "activeComponent",
    data: {
        is: "page/cloud/pages/scf-storage/scf-storage"
    }
});

const demoImageFileId = require("../../../../config").demoImageFileId; // 参考文档：https://developers.weixin.qq.com/miniprogram/dev/wxcloud/reference-server-api/storage/
