...
const appTransformation = require('./classSubdirectory/app.js');
const pageTransformation = require('./classSubdirectory/page.js');
const componentTransformation = require('./classSubdirectory/component.js');
