...
const { getVersion } = require('@antmove/utils')
...
console.log(
  chalk.green('欢迎使用蚂蚁搬家工具，您可以通过如下地址寻求帮助或是给予反馈。'),
)
...
module.exports = function(opts = {}, cb = () => {}) {
  ...
  inquirer.prompt(ret).then((answers) => {
    ...
    if (
      isMac === 'darwin'
      && answers.output.charAt(answers.output.length - 1) !== '/'
    ) {
